...
$result = mysqli_query($conn, "SELECT * FROM pengaduan INNER JOIN masyarakat ON pengaduan.nik = masyarakat.nik WHERE pengaduan.status = 'proses' ORDER BY pengaduan.id_pengaduan DESC");
$notif = mysqli_query($conn, "SELECT * FROM pengaduan WHERE status = 'proses' ORDER BY id_pengaduan DESC ");
?>
<!DOCTYPE html>

<div class="yu">
  <h6>LAPORAN PROSES</h6>
  <hr>
<div class="konten laporanproses"> 
  <?php if($_SESSION['user']['level']=="admin") {?>
<a href="exportPdfStatus.php?status=proses" target="_blank" class="btn btn3"><i class="fa-solid fa-file-pdf"></i></a>
  <?php } ?>
  <?php
