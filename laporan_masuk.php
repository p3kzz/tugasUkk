  ...
  <?php if(!empty($dt['id_tanggapan'])) {?>
    ...
    ?>
     ...
     <div class="aksi">
      ...
      <button type="button" class="btn btn-secondary"><a href="index2.php?laporan_proses">kembali</a></button>
      <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?= $id_pengaduan; ?>">Hapus</button>
     </div>
    </form>
    <?php } } else { ?>
      <div class="aksi">
        <button type="button" class="btn btn-secondary"><a href="index2.php?laporan_selesai">kembali</a></button>
        <?php if($_SESSION['user']['level']=="admin") {?>
        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?= $id_pengaduan; ?>">Hapus</button>
        <?php } ?>
      </div>
    ...
    <div class="tanggapan">
      <form action="" method="post">
        ...
        <label style="margin-left: 30px; margin-top: -10px;">Status</label>
        ...
        <div class="aksi">
          ...
          <button type="button" class="btn btn-secondary"><a href="index2.php?lihat_laporan_adpt">kembali</a></button>
          <?php if($_SESSION['user']['level']=="admin") {?>
          <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?= $id_pengaduan; ?>">Hapus</button>
          <?php }?>
        </div>
